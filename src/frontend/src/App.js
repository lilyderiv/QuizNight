      ...
      <div className="app-container">
        ...
        {currentView === "settings" && (
          <div className="settings-page-container">
            ...
            {/* GERİ DÖN BUTONU */}
            <button
              className="auth-button neon-box back-button"
              onClick={goBack}
            >
        ...
        {currentView === "createQuizSettings" && (
          <div className="cq-container">
            ...
            <div className="cq-form-area">
              ...
              <div className="cq-row">
                <div className="cq-label neon-box">
                  <span className="neon-text">Quizin Pini</span>
                </div>
                <div className="cq-input neon-text cq-pin-display">
                  {quizForm.pin}
                </div>
              </div>
          ...
          <div className="qq-container">
            ...
            <div className="qq-main-box neon-box">
              ...
              {!currentQ.imagePreview &&
                !currentQ.text &&
                !currentQ.isSelectingType && (
                  <button
                    className="qq-giant-plus"
                    onClick={() =>
                      updateCurrentQuestion({ isSelectingType: true })
                    }
                  >
                    ...
                    {ans.isEditing && (
                      <div className="qq-answer-edit-mode">
                        <textarea
                          ...
                          value={ans.text}
                          onChange={(e) =>
                            handleAnswerChange(ans.id, e.target.value)
                          }
                          autoFocus
                        />
                        <button
